...
- useRef's can be useful if a component's hierarchy is weird.
- Encapsulating things in a form and using the onSubmit can target all the wanted input's based on their id=""
- always use htmlFor (for) attributes on labels to target the input's id's
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=sambenwatson%40gmail.comsambenwatson%40gmail.com).
