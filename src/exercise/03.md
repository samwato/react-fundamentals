...
Babel will take jsx and convert to normal javascript that call the react api, eg React.createElement()

Expression (things that resolve to a value) are only valid in interpolated jsx eg. <div>{}</div>.
Not if statements but can do ternary operators

you can also spread children props to something that breaks the html convention looking elements. eg
"<div {...props} />"
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=sambenwatson%40gmail.comsambenwatson%40gmail.com).
