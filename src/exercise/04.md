...
Using the React built in prop types is really good for creating components that other developers will use.
Perfect case for Opengear when we create component libaries as they throw errors when developing, not prod.

However using Typescript is going to do what prop-types is doing so no need to use it.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=sambenwatson%40gmail.comsambenwatson%40gmail.com).
